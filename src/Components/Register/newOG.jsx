...
const NewOGRegUserDataTable = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get("https://api.batcave.club/batcave/api/user?membershipType=OG");
    ...
    return (
        <div style={{ overflow: "scroll", marginTop: "100px" }}>
            <h2 style={{ textAlign: "left", margin: "20px" }}>ORIGINAL GEARHEADS</h2>
...
export default NewOGRegUserDataTable;
